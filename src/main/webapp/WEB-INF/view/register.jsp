			...
			<div
				...
				<nav class="main_nav">
					<ul>
						...
						%>
								<li><a
									href="${pageContext.request.contextPath}/categoryProductListController?categoryNo=<%=c.getCategoryNo()%>"><%=c.getType()%></a></li>
								<%		
							}
						%>
							</ul></li>
				...
				<div class="header_content ml-auto">
					...
					<div class="shopping">
						<a href="#">
							<div class="cart">
								<img
									src="${pageContext.request.contextPath}/images/shopping-bag.svg"
									alt="">
									...
									<table class="table">
										<tr>
											...
											<th><input type="text" class="form-control"
												placeholder="Enter ID" name="customerId"></th>
										</tr>
